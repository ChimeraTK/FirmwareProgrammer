...
# Parameters
# #1 number of the slot with SIS8300L: from 3 to 12
# #2 revision from which FPGA will be booted, from 1 to 3
# #3 file with firmware: firmware.bit

echo ""
echo "FPGA configuration memory switcher for SIS8300L board"
...
function print_usage {
	echo "Usage:"
        echo "  $0 <Number of the slot with SIS8300L: 1-12> <Memory bank with firmware: 0-1>"         
        exit -1
}
